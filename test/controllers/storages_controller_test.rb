...
class StoragesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create storage" do
    assert_difference('Storage.count') do
      post storages_url, params: { storage: { address: @storage.address, branch_id: @storage.branch_id, city_id: @storage.city_id, latitude: @storage.latitude, longitude: @storage.longitude } }
    end
  ...
  test "should update storage" do
    patch storage_url(@storage), params: { storage: { address: @storage.address, branch_id: @storage.branch_id, city_id: @storage.city_id, latitude: @storage.latitude, longitude: @storage.longitude } }
